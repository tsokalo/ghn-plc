 ...
 */
#ifndef GHN_PLC_PACKET_SINK_HELPER_H
#define GHN_PLC_PACKET_SINK_HELPER_H
 ...
 * on a set of nodes.
 */
class GhnPlcPacketSinkHelper
{
public:
  /**
   * Create a GhnPlcPacketSinkHelper to make it easier to work with PacketSinkApplications
   *
   ...
   *
   */
  GhnPlcPacketSinkHelper (std::string protocol, Address address);
...
#endif /* GHN_PLC_PACKET_SINK_HELPER_H */
