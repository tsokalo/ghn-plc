...
// Helper functions
size_t EncodedBits (size_t uncoded_bits, CodingType ct);
size_t RequiredSymbols (size_t encoded_bits, ModulationType mt, size_t subbands);
...
public:
	...
	*/
	...
	void RxPsdChanged (uint32_t txId, Ptr<const SpectrumValue> newRxPsd);
        ...
        /**
         * \brief Set the global header symbol duration value for all PHYs
         *
         * \param tSymbol Duration of a header modulation symbol
         */
        static void SetHeaderSymbolDuration (Time tSymbol);

        /**
         * \return The global header modulation symbol duration
         */
        static Time GetHeaderSymbolDuration (void);
...
protected:
	static Time header_symbol_duration;
