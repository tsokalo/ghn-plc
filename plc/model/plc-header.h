...
public:
	...
	void SetPayloadMt (ModulationType mt) { m_payload_mt = mt; }
	ModulationType GetPayloadMt (void) { return (ModulationType) m_payload_mt; }
        void SetPayloadCt (CodingType ct) { m_payload_ct = ct; }
        CodingType GetPayloadCt (void) { return (CodingType) m_payload_ct; }
...
private:
	...
	uint8_t m_payload_mt;
        uint8_t m_payload_ct;
