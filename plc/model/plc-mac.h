...
public:
	...
	//tsokalo
	void SetBackoffSlotDuration (Time duration) { m_backoffSlotDuration = duration; }
	Time GetBackoffSlotDuration (void) { return m_backoffSlotDuration; }
	...
	*/
	...
	//tsokalo
	void SetBackoffValueCallback(BackoffValueCallback cb){m_backoff_callback = cb;}
	//tsokalo
	void SetState(MacState state);
...
protected:
	...
	//tsokalo
	BackoffValueCallback m_backoff_callback;
	MacState m_state;
};
