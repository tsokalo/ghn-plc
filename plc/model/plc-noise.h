...
public:
	...
	PLC_TimeVaryingNoiseSource (Ptr<PLC_Node> src_node, Ptr<SpectrumModel> sm, Ptr<RandomVariableStream> subChannelPsd, Ptr<RandomVariableStream> staticDuration);
...
private:
    Ptr<RandomVariableStream> m_subChannelPsd;
    Ptr<RandomVariableStream> m_staticDuration;
};
...
public:
	 ...
	 * @param pulselen_gen Ptr<RandomVariableStream> for the pulse duration generator
	 * @param pulsegap_gen Ptr<RandomVariableStream> for the silence duration generator
	 */
	PLC_ImpulsiveNoiseSource(Ptr<PLC_Node> src_node, Ptr<SpectrumValue> noisePsd, Ptr<RandomVariableStream> pulselen_gen, Ptr<RandomVariableStream> pulsegap_gen);
...
private:
	Ptr<RandomVariableStream>	m_pulse_len;
	Ptr<RandomVariableStream>	m_pulse_gap;
};
