...
//	Ptr<PLC_ErrorRatePhy> phy2 = CreateObject<PLC_ErrorRatePhy> ();
	...
	phy1->SetHeaderModulationAndCodingScheme (ModulationAndCodingScheme (BPSK, CODING_RATE_1_2, 0));
	phy2->SetHeaderModulationAndCodingScheme (ModulationAndCodingScheme (BPSK, CODING_RATE_1_2, 0));
	phy1->SetPayloadModulationAndCodingScheme (ModulationAndCodingScheme (QAM4, CODING_RATE_RATELESS, 0));
	phy2->SetPayloadModulationAndCodingScheme (ModulationAndCodingScheme (QAM4, CODING_RATE_RATELESS, 0));
