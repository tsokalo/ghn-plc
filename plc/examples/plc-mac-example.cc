...
int main (int argc, char *argv[])
{
	...
	phy1->SetPayloadModulationAndCodingScheme (ModulationAndCodingScheme (BPSK, CODING_RATE_RATELESS, 0));
	phy2->SetPayloadModulationAndCodingScheme (ModulationAndCodingScheme (BPSK, CODING_RATE_RATELESS, 0));
